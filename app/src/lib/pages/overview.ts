...
import {formatDate, formatInteger, formatNumber} from "../format.ts";
import {metricCards} from "../components/summary-cards.ts";
import {queryRows} from "../duckdb.ts";

function section(title: string, copy: string): HTMLDivElement {
...
export async function mountOverviewPage(root: HTMLElement): Promise<void> {
